...
export default function GamesClientWrapper({ games, allGenres, paginationMeta }: GamesClientWrapperProps) {
    ...
    <div className="space-y-8 font-mono text-xs">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 bg-[#0d0f1a]/60 border border-white/5 p-4 rounded-xl backdrop-blur-md shadow-xl items-end">
        ...
        <div className="md:col-span-3">
          <Select variant="secondary" className="w-full" placeholder="Sort Vector" value={currentSort} onChange={(val) => updateParams([{ key: "sortBy", value: val }, { key: "page", value: "1" }])}>
            ...
            <Select.Popover className="bg-[#0d0f1a] border border-white/10 rounded-lg p-1 mt-1 z-50 shadow-2xl">
              <ListBox className="text-xs text-gray-300">
                <ListBox.Item id="default" textValue="Sort Vector: Default" className="px-3 py-2 rounded hover:bg-white/5 cursor-pointer flex items-center justify-between data-[selected=true]:text-cyan-400">Sort Vector: Default<ListBox.ItemIndicator /></ListBox.Item>
